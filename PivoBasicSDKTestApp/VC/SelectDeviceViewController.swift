...
class SelectDeviceViewController: UIViewController, UIImagePickerControllerDelegate {
  
  static func storyboardInstance() -> UINavigationController? {
    let storyboard = UIStoryboard(name: String(describing: SelectDeviceViewController.self),
                                  bundle: nil)
...
extension SelectDeviceViewController: PivoConnectionDelegate {
  ...
  private func handleRotatorConnected() {
    // Open next view
    if let vc = ControlRotatorVC.storyboardInstance() {
